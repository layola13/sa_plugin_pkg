...
pub const Plugin = struct {
    ...
    handleCommand: ?*const fn (ctx: *const Context, argv: []const []const u8, stdout: @import("std").io.AnyWriter, stderr: @import("std").io.AnyWriter) anyerror!?u8 = null,
...
test "pkg plugin_api exposes standalone definitions" {
    _ = builtin;
